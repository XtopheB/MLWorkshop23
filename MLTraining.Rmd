---
title: "ML Training: "
subtitle: "Who? What? How? and ... .orange[What for?] "
author: "Christophe Bontemps"
institute: "*Statistical Institute for Asia and the Pacific* (UN ESCAP)"
date: "*UNECE Machine Learning for Official Statistics Workshop 2023*"
output:
...
### - My own views, no absolute truth

### - Based on 2 facilitated courses .orange[2021 & 2022] 


### **+** 1 Self-paced course .orange[(2022)]

### - Experience on e-learning only .orange[(1000 participants)] 


<br>

### *.orange[Bias]* due to 20+ years of academic work!
...
<center>
 ...
 <img src="Myimages/SIAP_logo_Big.png", width="65%">
...
* My name is Christophe Bontemps, I work at the Statistical Institute for Asia and the pacific, where I teach data Science (data visualization, ML, Big Data,..). Also a member of he Committee of Experts on Big Data (task team on Capacity Building and Training)
...
### .orange[Teaching]: to provide knowledge, instruction or information --> No software needed

<br>
### .orange[Training]: to develop abilities through practice with instruction or supervision --> Software baseded 

]]
.column.bg-main3[.content.vmiddle.center[

<img src="Myimages/teaching_vs_learning.png", width="100%">
...
## Teaching as a prequerisite for training
<br>

## Some guiding ideas

### - Open  the .orange[*black-box*]

### - Mathematical fundations --> roots in .orange[*actual*]  toolbox

### - Shifting "from inference to prediction"
...
<img src="Myimages/SIAP_logo_Big.png", width="30%">
<br>

<img src="Myimages/SIAP-E-learning.gif", width="110%">
...
<table style="width:100%">
  <tr>
    <td><img src="Myimages/BigDataGWGMaketPlace.jpg", width="80%"></td>
    <td><img src="Myimages/UN-SDG-Learn.jpg", width="60%"></td>
  </tr>
  <tr>
    <td><img src="Myimages/UNBigData.gif", width="90%"></td>
    <td><img src="Myimages/E-learningUN-SDG.gif", width="100%"></td>
  </tr>
  <tr>
    <td><img src="Myimages/WorldBankElearning.jpg", width="50%"></td> 
    <td><img src="Myimages/Eurostat-Elearning.jpg", width="50%"></td>
  </tr>
  <tr>
    <td><img src="Myimages/E-learning-WorldBank.gif", width="120%"></td>
    <td><img src="Myimages/E-learningPortals-Eurostat.gif", width="120%"></td>
  </tr>
</table>
...
#### .orange[Satellite Myimages] integration, .orange[land recognition] 
...
# .left[.SiapCol[..Big Data "chunks"!]]
 ...
 <br>
<img src="Myimages/GISIntegration.png", width="60%">

<br>
<img src="Myimages/WebScrapping.jpg", width="40%">
]]
...
<br>
<center> <img src="Myimages/SIAP_logo_Big.png", width="20%"> </center>
...
<center> <img src="Myimages/SIAP_logo_Big.png", width="40%"> </center>
<br>
